...
@Component({
  selector: 'app-add-edit-consulta',
  templateUrl: './add-edit-consulta.component.html',
  styleUrls: ['./add-edit-consulta.component.scss']
})
export class AddEditConsultaComponent implements OnInit {
  ...
  constructor(private resource: ConsultaResourceService,
              ...
              private ref: MatDialogRef<AddEditConsultaComponent>, private builder: FormBuilder,
              private service: ConsultaResourceService) {
  }
  ...
  setData(item: ConsultaInterface) {
