...
@Component({
  selector: 'app-search-medico-dialog',
  templateUrl: './search-medico-dialog.component.html',
  styleUrls: ['./search-medico-dialog.component.scss']
})
export class SearchMedicoDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private ref: MatDialogRef<SearchMedicoDialogComponent>,
